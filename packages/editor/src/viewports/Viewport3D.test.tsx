...
describe("entity rendering", () => {
  ...
  it("renders mesh for each entity with spatial + renderable", () => {
    ...
    const meshes = document.querySelectorAll("[data-entity-id]")
  ...
  it("does not render entities with renderable.visible=false", () => {
    ...
    expect(meshes[0]?.getAttribute("data-entity-id")).toBe("visible")

    unmount()
  })

  it("renders correct entity IDs as data-entity-id", () => {
...
describe("click to select", () => {
  ...
  it("clicking a mesh selects that entity in the store", () => {
    ...
    const mesh = document.querySelector('[data-entity-id="e1"]')!
  ...
  it("selected entity has data-selected=true", () => {
    ...
    const e1Mesh = document.querySelector('[data-entity-id="e1"]')
    const e2Mesh = document.querySelector('[data-entity-id="e2"]')

    expect(e1Mesh?.getAttribute("data-selected")).toBe("true")
    expect(e2Mesh?.getAttribute("data-selected")).toBe("false")
